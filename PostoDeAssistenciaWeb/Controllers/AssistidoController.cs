...
namespace PostoDeAssistenciaWeb.Controllers
{
    public class AssistidoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NomeCompleto,Sexo,Idade,DataNascimento,GrauParentesco,Telefone1,Telefone2,NumeracaoCalcado,NumeracaoRoupaSuperior,NumeracaoRoupaInferior,Observacao,Principal,DependenteId")] Assistido assistido)
        {
            if (ModelState.IsValid)
            {
                assistido.Id = Guid.NewGuid();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NomeCompleto,Sexo,Idade,DataNascimento,GrauParentesco,Telefone1,Telefone2,NumeracaoCalcado,NumeracaoRoupaSuperior,NumeracaoRoupaInferior,Observacao,Principal,DependenteId")] Assistido assistido)
        {
            if (ModelState.IsValid)
            {
